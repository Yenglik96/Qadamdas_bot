...
def set_name(update: Update, context: CallbackContext):
    ...
    update.message.reply_text(f"Сәлеметсіз бе, Qadamdas марафонына қош келдіңіз!

Атыңызды сәтті тіркедік: {full_name}
...
def main():
    ...
    dp.add_handler(CommandHandler("атын_өзгерту", set_name))
